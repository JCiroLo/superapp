  ...
  Modal(:show="selectedUser" @closeModal="selectedUser = null")
    ...
    template(#modal-body)
      form.app-form(noValidate @submit.prevent="editUser" )
        .form-field
          label Username
          input(type="text" placeholder="Username" v-model="selectedUser.username")
        .form-field
          label Cédula
          input(type="number" placeholder="Cédula" v-model="selectedUser.cedula")
        .form-field
          label Nombre
          input(type="text" placeholder="Nombre" v-model="selectedUser.name")
        .form-field
          label Apellido
          input(type="text" placeholder="Apellido" v-model="selectedUser.lastName")
        .form-field
          label Correo
